...
const CountryField = (props) => {
  return (
    <select name="country" className={props.status !== 400 ? classes.field : `${classes.field} ${classes.error}`} id="country">
      <option value={"0"} label="Select a country... " defaultValue={"select"}>
        Select a country ...{" "}
      </option>
